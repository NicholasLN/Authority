                                    ...
                                    <form method='POST'>
                                        <table class='table table-striped'>
                                            ...
                                            <tr>
                                                ...
                                                class="form-control" aria-label="Confidence" placeholder="95%" id='pollConfidence' name='pollConfidence' max='99'>
                                                </td>
                                                <td>
                                                    <input type='input' class='form-control' placeholder="1,000" id='sampleSize' name='sampleSize'>
                                                </td>
                                                <td>
                                                    <input type="submit" class="btn btn-primary" value='Conduct Poll' name='pollSubmit' />
                                                    <br />
                                                    <label id='pollCost'>
            ...
            <script>
                $(document).ready(function() {
                    $('#pollConfidence').on('input', function postinput() {
                        console.log($('#pollConfidence').val()) 
...
foreach($stateDemographics as $demographic){
    Demographic::calcDemSupport($demographic,$loggedInUser);
}